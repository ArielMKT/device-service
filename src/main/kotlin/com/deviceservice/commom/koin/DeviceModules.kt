...
import com.deviceservice.resources.persistence.DeviceStateRepositoryImpl
...
val deviceStateModule: Module = module {
    single { DeviceStateController(get()) }
    single { DeviceStateService(get()) }
    single<DeviceStateRepository> { DeviceStateRepositoryImpl() }
}
